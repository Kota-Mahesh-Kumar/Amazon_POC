...
with col1:
    cat = st.selectbox("Category", ['All','Electronics', 'Home & Kitchen', 'Grocery & Gourmet', 'Beauty', 'Health & Personal Care'])
with col2:
    sub_cat = st.selectbox("Sub-Category", ['All', 'Sofas & Couches', 'TV & Entertainment Units', 'Jars & Containers', 'Drinks', 'Container Insulators', 'Tea Lights' ])
with col3:
