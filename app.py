...
styled_comparison_df = comparison_df.style.applymap(lambda cell: 'background-color: green' if cell == 'MATCH' else ('background-color: orange' if cell == 'MISMATCH' else ''), subset=comparison_df.columns[1:])
